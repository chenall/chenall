...
1. 可以备份或恢复系统。 
2. 支持直接增量更新. 
3. 支持WINDOWS 7及以上系统包括win10(未完全测试)  
4. 可以作为系统备份工具来使用。  
5. 自动识别WIMBoot系统WIM文件。 
6. 自己去发现.
...
2015-06-16 v1.8版
  1. 修正一个BUG.
  2. 驱动更新,解决NTFS软硬链接的问题.(已经有装过的,可以删除原系统drivers目录下的wof.sys文件,然后使用增量更新来原地转换功能即可更新为最新版驱动)
...
* ### 使用WIMBoot之后启动动画变成了滚动条,这个可以使用最新版本,选中**启动动画**参数即可恢复原来的启动动画.
